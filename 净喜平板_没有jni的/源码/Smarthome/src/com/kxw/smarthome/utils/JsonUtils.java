...
//	public static void getWeather(Context context ,String jsonStr){
//
...
//			weatherInfo.setProvince(SharedPreferencesUtil.getStringData(context, "province", ""));
//			weatherInfo.setDistrict(SharedPreferencesUtil.getStringData(context, "district", ""));
...
//	};
	...
	public static <T> ArrayList<T> jsonToArrayList(String json, Class<T> clazz){
		...
		System.out.println("jsonToArrayList = "+json);
	...
	public static String getStoreJson(int pages) {
		...
		try {
			...
			jObj.accumulate("deviceCode", SharedPreferencesUtil.getStringData(MyApplication.getInstances(), "pro_no", ""));
	...
	public static int tag(String jsonStr){
		MyLogger.getInstance().e("jsonStr ="+jsonStr);	
		int tag = -1;	
		try {	
			tag=new  JSONObject(jsonStr).getInt("tag");
		} catch (JSONException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}

...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setImageResources(List<AdvInfo> infoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
	...
	public class ImageCycleAdapter extends PagerAdapter {
		 ...
		 * 图片资源列表
		 */
		private List<AdvInfo> mAdvList = new ArrayList<AdvInfo>();
		...
		public ImageCycleAdapter(Context context, List<AdvInfo> adList, ImageCycleViewListener imageCycleViewListener) {
			mContext = context;
			mAdvList = adList;
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			{
				String imageUrl = mAdvList.get(position).getAdv_imgurl();
				...
				imageView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						mImageCycleViewListener.onImageClick(mAdvList.get(position),position, v);
					}
				});
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(AdvInfo info, int postion, View imageView);
	}

	public ViewGroup getmGroup() {
		return mGroup;
	}
	...
	public void setmAdvAdapter(ImageCycleAdapter mAdvAdapter) {

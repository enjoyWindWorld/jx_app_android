 ...
 * reaching the last or first layout_wd_dd_item, default is true</li>
 * <li>{@link #setSlideBorderMode(int)} set how to process when sliding at the
 * last or first layout_wd_dd_item</li>
...
public class AutoScrollLoopViewPager extends ViewPager {
    ...
    /**
     * do nothing when sliding at the last or first layout_wd_dd_item *
     */
    public static final int SLIDE_BORDER_MODE_NONE = 0;
    /**
     * deliver event to parent when sliding at the last or first layout_wd_dd_item *
     */
    ...
    /**
     * whether automatic cycle when auto scroll reaching the last or first layout_wd_dd_item,
     * default is true
     */
    ...
    /**
     * how to process when sliding at the last or first layout_wd_dd_item, default is
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT) {
            ...
            if (currentItem == 0 || currentItem == pageCount - 1) {
                 ...
                 * else scroll to last one when current layout_wd_dd_item is first one, scroll to
                 * first one when current layout_wd_dd_item is last one.
                 */
     ...
     * layout_wd_dd_item, default is true
     *
    ...
    /**
     * get how to process when sliding at the last or first layout_wd_dd_item
     *
    ...
    /**
     * set how to process when sliding at the last or first layout_wd_dd_item
     *

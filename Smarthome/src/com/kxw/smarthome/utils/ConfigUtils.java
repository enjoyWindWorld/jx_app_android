...
//	public static String base_url ="http://192.168.1.46:8080/jx_smart/smvc";
	...
	// 高清视频，空间大
	static String downloadPath = "http://113.106.93.195:21080/pic/jingxi1010.mp4";
	// 非高清，空间小
	public static String[] videoPath = new String[] {
			"http://113.106.93.195:21080/pic/jingxi1228.mp4",
			"http://113.106.93.195:21080/pic/jingxi011801.mp4",
			"http://113.106.93.195:21080/pic/jingxi011802.mp4" };

	public static String file_path = Environment.getExternalStorageDirectory()
			.getPath() + "/.kxw" + "/video.mp4";

	// public static String
	// upgrade_url="http://192.168.1.46:8080/edu_pay/smvc/launch/test/visit.v";
	// public static String
	// get_adv_url="http://192.168.1.46:8080/edu_pay/smvc/launch/test/getAdver.v";

	public static String upgrade_url = base_url + "/launch/test/visit.v";
	public static String get_adv_url = base_url + "/launch/test/getAdver.v";
	...
	public static String binding_back_url = base_url + "/user/test/tabletbindingback.v";
	...
	public static String upgrade_version_alarm = "UPGRADE_VERSION_ALARM"; // 滤芯上传广播

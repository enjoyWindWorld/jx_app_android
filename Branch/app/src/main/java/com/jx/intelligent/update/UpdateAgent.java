...
//        updateParams.clientType = "android";
//        updateParams.appName = "driver";
...
//                    if (resultBean.retCode.equals("000000")) {
//                        UpdateResultBean.UpdateInfoBean updateInfoBean = resultBean.result;
//                        responseInfos.put(UpdateInfo.VERSION, updateInfoBean.versionNo+"");
//                        responseInfos.put(UpdateInfo.MESSAGE, updateInfoBean.description);
//                        responseInfos.put(UpdateInfo.URL, updateInfoBean.dloadUrl + "DCBDriver.apk");
//                        responseInfos.put(UpdateInfo.SIZE, updateInfoBean.packageSize + "");
//                    }

                    if (resultBean.result.equals(Constant.retCode_ok) && resultBean.data.size()>0) {
            ...
            mDialog = new NormalAlertDialog.Builder(activity)
                    ...
                    .setOnclickListener(new DialogOnClickListener() {
                        ...
                        public void clickLeftButton(View view) {
                            mDialog.dismiss();
                            RHBaseApplication.getMainActivity().exitApp();
                        }

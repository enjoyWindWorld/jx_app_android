 ...
 */
public class MyWaterPurifierActivity extends RHBaseActivity {

    private static final String TAG = "MyWaterPurifierActivity";
    ...
    private void goFilterElementStatusOrPrice(GetMyWPListResult.WaterPurifierBean waterPurifierBean) {
        Intent intent = new Intent(MyWaterPurifierActivity.this, GoFilterElementStatusOrPriceActivity.class);
...
//                .setRightClickListener(this);
    ...
    protected void findView(View contentView) {
        ...
        dialog = new ProgressWheelDialog(MyWaterPurifierActivity.this);
    }
    ...
    public void getMyWaterPurifierList() {
        ...
        dialog.show();
        userCenterDao.getMyWaterPurifierListTask(SesSharedReferences.getUserId(MyWaterPurifierActivity.this), "0",  page+"", new ResponseResult() {
    ...
    private void goSharedBindings() {
        Intent intent = new Intent(MyWaterPurifierActivity.this, SharedBindingsActivity.class);

package com.jx.intelligent.view.loopview;
...
public class LoopView extends View {
    ...
    private void initLoopView(Context context) {
        ...
        colorBlack = 0xff333333;// 选中的字体的颜色
    ...
    public void setOnTouchStutListen(OnTouchStutListen onTouchStutListen) {
        this.onTouchStutListen = onTouchStutListen;
    }

    public OnTouchStutListen onTouchStutListen;

    public interface OnTouchStutListen {
    ...
    public boolean onTouchEvent(MotionEvent motionevent) {
        ...
        switch (motionevent.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (onTouchStutListen != null) {
                    onTouchStutListen.onTouchStart();
                }

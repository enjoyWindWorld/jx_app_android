...
public class AppUtil {
    ...
    public static String getPackageName() {
        return RHBaseApplication.getContext().getPackageName();
    }
    ...
    public static String getVersionName() {
        try {
            return RHBaseApplication.getContext().getPackageManager().getPackageInfo(getPackageName(), 0).versionName;
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static int getVersionCode() {
        try {
            return RHBaseApplication.getContext().getPackageManager().getPackageInfo(getPackageName(), 0).versionCode;

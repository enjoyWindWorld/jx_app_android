...
import com.jx.intelligent.ui.fragments.RepairTaskListFragment;

public class TaskManageActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.titlebar_center_tv)).setText("售后与评价");
        ...
        titlebar_right_tv.setText("添加");
        titlebar_right_tv.setVisibility(View.VISIBLE);
        titlebar_right_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TaskManageActivity.this, CustomerServiceTypeActivity.class);
